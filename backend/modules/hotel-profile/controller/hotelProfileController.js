...
const hotelProfileController = {
    addNewHotel: async (req, res) => {
        try {
            ...
            // FIX: Loại bỏ dấu cách thừa ở cuối template string
        ...
        // =================== CODE CŨ (ĐÃ SỬA) ===================
        /*
        // CODE CŨ: Có dấu cách thừa ở cuối template string
        return responseUtils.ok(res, { message: `Add hotel ${hotelName.hotelName} successfully ` });
        */
    },
    ...
    disableHotel: async (req, res) => {
        try {
            ...
            return responseUtils.ok(res, { message: "Hotel deleted successfully" });
        } catch (error) {
            return responseUtils.error(res, error.message);
        }
