...
Entry point for ML service (Churn Prediction, etc.)
"""
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        app_logger.error(f"Failed to load ML models: {e}", exc_info=True)

    app_logger.info("ML Service started successfully")

    yield  # Application is running

    # Shutdown
    app_logger.info("Shutting down ML Service")
    app_logger.info("ML Service shut down successfully")


# ========== Create FastAPI App ==========

app = FastAPI(
    title="Hotel AI - ML Service",
    description="Machine Learning Service for Churn Prediction & Analytics",
    version="0.1.0",
    debug=settings.debug,
    lifespan=lifespan,
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        "src.application.controllers.ml.main:app",
        host=settings.api_host,
        port=8002,
