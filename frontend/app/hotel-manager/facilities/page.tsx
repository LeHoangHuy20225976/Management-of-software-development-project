...
export default function HotelManagerFacilitiesPage() {
  ...
  const getCategoryName = (categoryId: string) => {
    return (
      facilityCategories.find((c) => c.id === categoryId)?.name || categoryId
    );
  };
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Cấu hình các tiện nghi có tại khách sạn của bạn
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="text-2xl font-bold text-gray-600">
            {facilities.length - activeFacilitiesCount}
          </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
        <div className="p-4 border-b bg-gray-50">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Nhấn vào tiện nghi để bật/tắt hiển thị trên trang khách sạn
          </p>
        </div>
          ...
          {filteredFacilities.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mt-1">
                Thêm tiện nghi mới cho danh mục này
              </p>
            </div>
          ) : (
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Để trống sẽ sử dụng icon mặc định ✨
                </p>
              </div>
