...
export default function HotelDetailPage({ params }: { params: Promise<{ slug: string }> }) {
        ...
        <div className="min-h-screen bg-gray-50 py-12">
          <div className="container mx-auto px-4">
            <Card className="text-center py-12">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Không tìm thấy khách sạn</h1>
              <p className="text-gray-600 mb-6">Khách sạn này không tồn tại hoặc đã bị xóa</p>
              <Link href="/search">
  ...
  const rooms = [
    { id: '1', name: 'Phòng Standard', price: hotel.basePrice, size: '25m²', bed: '1 giường đôi', guests: 2 },
    { id: '2', name: 'Phòng Deluxe', price: hotel.basePrice * 1.3, size: '32m²', bed: '1 giường king', guests: 2 },
    { id: '3', name: 'Phòng Suite', price: hotel.basePrice * 1.8, size: '45m²', bed: '1 giường king + Sofa', guests: 3 },
  ];
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Tiện ích</h2>
                      ...
                      <div className="flex items-start gap-3 mb-2">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-1">
                            <h4 className="font-bold text-gray-900">Người dùng {i}</h4>
                          ...
                          <p className="text-gray-700">
                            Khách sạn rất đẹp, sạch sẽ và nhân viên thân thiện. Sẽ quay lại lần sau!
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-20">
                <Card>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Đặt phòng</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="font-semibold text-gray-900">{formatCurrency(hotel.basePrice)}</span>
                      </div>
                      <div className="flex justify-between mb-2">
                        <span className="text-gray-600">Thuế & phí</span>
                        <span className="font-semibold text-gray-900">{formatCurrency(hotel.basePrice * 0.1)}</span>
                      </div>
                      <div className="pt-2 border-t border-gray-200 flex justify-between">
                        <span className="font-bold text-gray-900">Tổng</span>
                        <span className="text-2xl font-bold text-[#0071c2]">
                          {formatCurrency(hotel.basePrice * 1.1)}
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      {!selectedRoom ? 'Chọn phòng để đặt' : 'Đặt ngay'}
                    </Button>
